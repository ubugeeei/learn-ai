...
| `headCount` $H$ | $C$ を分割する注意機構 (attention) のヘッド数 |
...
gather、位置の加算、RMSNorm、Q/K/V の射影、因果的注意機構、残差、FFN、共有
...
します。パラメータ数は、埋め込み、4 つの注意機構射影、2 つの正規化、2 つの
