...
1. [図で見る全体像と最小用語集](docs/ja/00-guide/09-visual-map-and-glossary.md)を
   読みます。
2. [説明と実装の網羅性監査](docs/ja/00-guide/10-coverage-audit.md)で、完成範囲と
   未完成範囲を確認します。
3. [学び方](docs/ja/00-guide/00-how-to-learn.md)を読みます。
4. [完全な実装章の構造](docs/ja/00-guide/04-chapter-anatomy.md)を読みます。
5. 小さな参照実装をゴールと誤解しないよう、
   [プロフェッショナル能力ロードマップ](docs/ja/00-guide/05-professional-roadmap.md)
   を読みます。
6. [カリキュラム](docs/ja/00-guide/01-curriculum.md)を順に進めます。
7. 完了した各章の検証コマンドを実行します。
8. 答えを読んだり実装したりする前に、演習を解きます。
9. 各パートの成果物を自分の言葉で説明します。
10. 各実装マイルストーンの後に、
